...
def _as_post_agent(invocation: HookInvocation) -> PostAgentInvocation:
    if not isinstance(invocation, PostAgentInvocation):
        raise TypeError(
            f"PostAgentHandler expected PostAgentInvocation, got"
...
class PostAgentHandler(HookHandler):
    ...
    def prepare_invocation(
        ...
        return _as_post_agent(invocation).model_copy(
